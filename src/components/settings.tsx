...
const Slippage = (props: {}) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ width: "50", fontSize: "14", boxShadow: "none", borderColor: "transparent", outline: "transparent", padding: "3px 10px 3px 3px", border: "1px solid #434343" }}>
        <NumericInput
    ...
    <>
      ...
      <div style={{ display: "grid" }}>
        ...
        <Select
          ...
          value={endpoint}
          style={{ marginLeft: "0px", background: "transparent" }}
        >
      ...
      <div style={{ display: "grid" }}>
        Wallet:{" "}
        <Select style={{ background: "transparent", marginLeft: "1px"}}onSelect={setProvider} value={providerUrl}>
